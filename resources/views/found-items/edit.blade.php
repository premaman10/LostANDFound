    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('found-items.update', $foundItem) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $foundItem->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="mt-1 block w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm" required>{{ old('description', $foundItem->description) }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="location" name="location" type="text" class="mt-1 block w-full" :value="old('location', $foundItem->location)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="date_found" name="date_found" type="date" class="mt-1 block w-full" :value="old('date_found', $foundItem->date_found->format('Y-m-d'))" required />
                        ...
                        @if($foundItem->image_path)
                            <div>
                                ...
                                <div class="mt-2">
                                    <img src="{{ Storage::url($foundItem->image_path) }}" alt="{{ $foundItem->name }}" class="h-32 w-32 object-cover rounded-lg">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ __('Update Found Item') }}</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
